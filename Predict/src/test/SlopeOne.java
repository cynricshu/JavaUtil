...
public class SlopeOne {
    public static void main(String args[]) {
        ...
        // items
        ItemId item1 = new ItemId("1");
        ItemId item2 = new ItemId("2");
        ItemId item3 = new ItemId("3");
        ItemId item4 = new ItemId("4");
        ItemId item5 = new ItemId("5");
    ...
    private void printMatrixes(Map<ItemId, Float> ratings,
        ...
        for (int j = 0; j < mAllItems.length; j++) {
            ...
            System.out.print(" ");
            System.out.format("%4d", frequencies.get(mAllItems[j]));
            System.out.print("   ");
        }
        System.out.println();
    }

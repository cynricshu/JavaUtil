...
//            int itemId = Integer.parseInt(in.nextLine());
            ...
            System.out.println("Prediction for single property: " + RatingPrediction.predict(userId, neighbourNum, Algorithm.SINGLE));
            System.out.println("Prediction for multiple property: " + RatingPrediction.predict(userId, neighbourNum, Algorithm.MULTIPLE));
            System.out.println("Prediction for ED: " + RatingPrediction.predict(userId, neighbourNum, Algorithm.ED));
            System.out.println();
        }
